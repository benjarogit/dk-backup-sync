# -*- coding: utf-8 -*-
"""Merge logic for Kodi favourites.xml. Union merge: result = union (deduplicated)."""
...
def parse_favourites(file_path):
    """Parse favourites.xml; return list of action strings."""
...
def write_favourites(file_path, action_list):
    """Write favourites.xml from list of action strings."""
...
def merge_union(local_actions, server_actions):
    """Union merge: result = local + (server entries not in local)."""
